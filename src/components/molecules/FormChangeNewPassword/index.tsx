...
import { FormChangePassword, InputOtp } from 'components';
            ...
            <form className="space-y-8">
               ...
               <div className="text-center">
                  ...
                  <button
                     ...
                     className={`cursor-pointer text-xs font-semibold leading-normal text-primary1 hover:text-primary1/90 ${
                        isReady ? '' : 'hidden'
                     }`}>
                     Resend
                  </button>
                  {!isReady && (
                     <div>00:{counter < 10 ? `0${counter}` : counter}</div>
                  )}
               </div>
            </form>
         ),
      ...
      return (
         <div className="space-y-4">
            ...
            <div
               ...
               className="cursor-pointer text-center text-xs font-semibold leading-normal text-primary1 hover:text-primary1/90">
               Back
            </div>
         </div>
      );
