...
const MyMarketsTableMemo = memo(
   (props: any, { kline, klineUpdatePeriod }: Props) => {
      useMarketsFetch();
         ...
         ? currentBidUnitMarkets
              ...
              .map(market => ({
                 ...
                 change: Decimal.format(
                    (+market.last - +market.open).toFixed(
                       market.price_precision
                    ),
                    market.price_precision
                 ),
...
export const MyMarketsTable = connect<ReduxProps, DispatchProps, {}, RootState>(
   mapStateToProps,
   mapDispatchProps
)(MyMarketsTableMemo);
