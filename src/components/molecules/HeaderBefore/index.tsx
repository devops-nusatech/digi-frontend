...
export const HeaderBefore: FC<HeaderProps> = ({
   ...
   const handleOutsideDropDwonCrypto = (e: any) => {
      if (refDropDwonCrypto && !refDropDwonCrypto?.current?.contains(e.target))
         setDropDwonCrypto(false);
   };
   ...
   useEffect(() => {
      ...
      return () =>
         document.removeEventListener('mousedown', handleOutsideDropDwonCrypto);
   }, []);
   useEffect(() => {
      ...
      <header
         ...
         <div className="header__center center">
            <Link
               ...
               to="/">
               <img
                  className="header__pic header__pic_desktop some-icon"
                  src={icLogoLight}
                  alt="Digiasset"
               />
               <img
                  className="header__pic header__pic_desktop some-icon-dark"
                  src={icLogoDark}
                  alt="Digiasset"
               />
               <img
                  className="header__pic header__pic_mobile"
                  src={icLogo}
                  alt="Digiasset"
               />
            </Link>
            <div className="header__wrapper">
               <div className="header__wrap js-header-wrap">
                  ...
                  <a
                     className="button-stroke header__button"
                     href="wallets/overview.html">
                     Wallet
                  </a>
               </div>
               <div
                  ...
                  className={`header__item header__item_settings js-header-item ${
                     dropDwonFlag ? 'active' : ''
                  }`}>
                  <button className="header__head js-header-head">
                     EN/USD{' '}
                     ...
                     <div className="header__row">
                        <div className="header__col">
                           ...
                           <div className="header__menu">
                              <a
                                 className="header__language active"
                                 href="#">
                              ...
                              <a
                                 className="header__language"
                                 href="#">
                                 <span className="header__flag">🇷🇺</span>Russia{' '}
                              </a>
                           </div>
                        </div>
                        <div className="header__col">
                           ...
                           <div className="header__menu">
                              <a
                                 className="header__currency active"
                                 href="#">
                                 USD
                              </a>
                              <a
