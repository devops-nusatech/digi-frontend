...
describe('Table', () => {
   describe('#render', () => {
      ...
      const filterMethod = (type: string) => (value: CellData[]) =>
         value[headerIndex] === type;
      ...
      it('should set selected row in props', () => {
         ...
         const result = component
            ...
            .first()
            .html();
         expect((component.state() as TableState).selectedRowKey).toEqual(
            selectedKey
         );
         ...
         const nextResult = component
            .find('.cr-table__row--selected')
            .first()
            .children()
            .first()
            .html();
         expect(newSelectedKey).toEqual(
            (component.state() as TableState).selectedRowKey
         );
      ...
      it('should filter data according to clicked filter', () => {
         ...
         const filteredStateLength = state.resultData
      ...
      it('should render the same length of background rows as data', () => {
         ...
         const wrapper = shallow(
            <Table
               rowBackground={renderRowBackground}
               data={data}
            />
         );
