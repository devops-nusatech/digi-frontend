...
describe('Markets', () => {
   ...
   it('should correctly filter rows', () => {
      expect(
         (wrapper.instance() as Markets).searchFilter(
            ['ETH/BTC', '0.123', '+50.00%'],
            'btc'
         )
      ).toBeTruthy();
   ...
   it('should set selected market in props', () => {
      ...
      const expectedSelectedRow = component
