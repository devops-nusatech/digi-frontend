...
const setup = (props: Partial<DecimalProps> = {}) => {
   ...
   return shallow(
      <Decimal {...{ ...defaultProps, ...props }}>123.3203020023</Decimal>
   );
};
...
describe('Decimal', () => {
   ...
   it('should have className for number after dot', () => {
      const wrapper = setup();
      expect(
         wrapper.find('span').last().hasClass('cr-decimal__opacity')
      ).toBeTruthy();
   });
   ...
   it('should handle format with thousands separator', () => {
      ...
      expect(Decimal.format(123456789.012345678, 6, ',')).toEqual(
         '123,456,789.012345'
      );
      expect(Decimal.format(123456789.012345678, 6, ' ')).toEqual(
         '123 456 789.012345'
      );
      expect(Decimal.format(1234567890123456, 0, ',')).toEqual(
   ...
   it('should handle format with float separator', () => {
      ...
      expect(Decimal.format(0.0000000167, 8, '', ',')).toEqual('0,00000001');
      expect(Decimal.format(0.0000000167, 8, '', ' ')).toEqual('0 00000001');
      expect(Decimal.format(1234567890123, 8, '', ',')).toEqual(
         '1234567890123,00000000'
      );
   });
   ...
   it('should handle format with thousands and float separator', () => {
      ...
      expect(Decimal.format(1234567890123456, 1, ' ', ',')).toEqual(
      ...
      expect(Decimal.format(1234567890.0134, 2, '.', ',')).toEqual(
         '1.234.567.890,01'
      );
   });
