...
export const DocumentationModels: React.FC = () => {
   ...
   if (
      ...
      Object.keys(documentation?.definitions).length
   ) {
      return (
         <div
            className="pg-documentation-item pg-documentation-models"
            id="models">
            <h4>
               {intl.formatMessage({ id: 'page.documentation.models.title' })}
            </h4>
