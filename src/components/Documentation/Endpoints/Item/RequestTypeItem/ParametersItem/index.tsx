...
export const ParametersItem: React.FC<ItemInterface> = (
   props: ItemInterface
) => {
   const { item } = props;
   const intl = useIntl();
   ...
   if (item.parameters && Object.keys(item.parameters).length) {
      return (
         <>
            <div className="flex w-1/6 justify-between font-medium">
               <div className="">
                  {intl.formatMessage({
            ...
            <div className="h-[1px] w-full rounded-xl bg-neutral6" />
            <Table
