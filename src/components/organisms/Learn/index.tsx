...
export const Learn = memo(() => {
   ...
   const { news, newsLoadig } = useNewsFetch(25, 'digiassetnews');

   return (
      <Section className="md-max:pb-20">
         <div
            id="learn"
               ...
               <Tab.Panel as={React.Fragment}>
                  <div className="-mx-4 after:clear-both after:table after:content-[''] lg2:-mx-4.5 lg2:-mt-8">
                     <div className="lg2-max:visible lg2-max:relative lg2-max:box-border lg2-max:block lg2-max:touch-pan-y lg2-max:select-none lg2-max:pb-[72px]">
                        ...
                        <button
                           type="button"
                           className="lg:hidden lg2-max:absolute lg2-max:bottom-0 lg2-max:left-4 lg2-max:z-2 lg2-max:flex lg2-max:h-10 lg2-max:w-10 lg2-max:items-center lg2-max:justify-center lg2-max:rounded-full lg2-max:text-none lg2-max:transition-all lg2-max:duration-200 lg2-max:hover:shadow-border lg2-max:hover:dark:shadow-border-dark">
                           <SVG
                              className="h-4 w-4 fill-neutral4 transition-all duration-200"
                              xlinkHref="arrow-prev"
                           />
                        </button>
                        <div className="lg:hidden lg2-max:relative lg2-max:m-0 lg2-max:block lg2-max:translate-x-0 lg2-max:overflow-visible lg2-max:p-0" />
                        <button
                           type="button"
                           className="lg:hidden lg2-max:absolute lg2-max:bottom-0 lg2-max:left-16 lg2-max:z-2 lg2-max:flex lg2-max:h-10 lg2-max:w-10 lg2-max:items-center lg2-max:justify-center lg2-max:rounded-full lg2-max:text-none lg2-max:transition-all lg2-max:duration-200 lg2-max:hover:shadow-border lg2-max:hover:dark:shadow-border-dark">
                           <SVG
                              className="h-4 w-4 fill-neutral4 transition-all duration-200"
