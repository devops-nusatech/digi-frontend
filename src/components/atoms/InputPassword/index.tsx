   ...
   return (
      <div>
         <InputGroup
            id="password"
            autoFocus={autoFocus}
            label={label ? label : translate('page.body.profile.header.account.content.password.new')}
            placeholder={label ? label : translate('page.body.profile.header.account.content.password.new')}
            value={password}
