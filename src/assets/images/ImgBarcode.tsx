...
export const ImgBarcode = ({ className, onClick }: ImageProps) => (
   <svg
      ...
      <rect
         width="4"
         height="4"
         transform="matrix(-1 0 0 1 106.5 15.5)"
         fill="#23262F"
      />
      <rect
         width="4"
         height="8"
         transform="matrix(-1 0 0 1 112.5 15.5)"
         fill="#23262F"
      />
      <rect
         x="106.5"
         ...
         width="4"
         height="4"
         transform="rotate(-180 106.5 111.5)"
         fill="#23262F"
      />
      <rect
         x="112.5"
         ...
         width="4"
         height="8"
         transform="rotate(-180 112.5 111.5)"
         fill="#23262F"
      />
      <rect
         width="4"
         height="4"
         transform="matrix(1 0 0 -1 21.5 111.5)"
         fill="#23262F"
      />
      <rect
         width="4"
         height="8"
         transform="matrix(1 0 0 -1 15.5 111.5)"
         fill="#23262F"
      />
      <defs>
         <pattern
