...
export const IcMasterCard = ({ className, onClick }: Props) => (
   <svg className={className} onClick={onClick} width="64" height="16" viewBox="0 0 64 16" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M44.8904 8C44.8904 12.4222 41.3126 16 36.8904 16C35.0237 16 33.3126 15.3556 31.957 14.2889C33.8237 12.8222 35.0015 10.5556 35.0015 8C35.0015 5.44444 33.8015 3.17778 31.957 1.71111C33.3126 0.644447 35.0237 0 36.8904 0C41.3126 0 44.8904 3.6 44.8904 8Z" fill="#F79E1B" />
   </svg>
);
