...
const ProfileLanguageMobileScreenComponent: React.FC = () => {
   ...
   const renderLanguageListItem = (language, index) => {
      const listItemClassName = classnames(
         'pg-mobile-profile-language-screen__list__item',
         {
            'pg-mobile-profile-language-screen__list__item--active':
...
export const ProfileLanguageMobileScreen = React.memo(
   ProfileLanguageMobileScreenComponent
);
