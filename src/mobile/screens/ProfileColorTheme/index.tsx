...
const ProfileThemeMobileScreenComponent: React.FC = () => {
   ...
   const renderThemeListItem = (colorTheme, index) => {
      const listItemClassName = classnames(
         'pg-mobile-profile-theme-screen__list__item',
         {
            'pg-mobile-profile-theme-screen__list__item--active':
...
export const ProfileThemeMobileScreen = React.memo(
   ProfileThemeMobileScreenComponent
);
