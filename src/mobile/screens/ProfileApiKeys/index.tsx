...
const ProfileApiKeysMobileScreenComponent: React.FC = () => {
   ...
   const firstElemIndex = useSelector((state: RootState) =>
      selectApiKeysFirstElemIndex(state, 4)
   );
   const lastElemIndex = useSelector((state: RootState) =>
      selectApiKeysLastElemIndex(state, 4)
   );
                     ...
                     {apiKeys.map((apiKey, index) => (
                        <ApiKeysItem
                           ...
                           handleUpdateKey={item =>
                              handleSetApiKeyProcess('update', item)
                           }
                           handleDeleteKey={item =>
                              handleSetApiKeyProcess('delete', item)
                           }
                        />
                     ))}
                     <Pagination
...
export const ProfileApiKeysMobileScreen = React.memo(
   ProfileApiKeysMobileScreenComponent
);
