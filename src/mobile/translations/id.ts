export const id = {
   'page.mobile.header.login': 'Log In',
   ...
   'page.header.login.forgotPassword': 'Forgot password?',
   'page.header.login.noAccountYet': 'No account yet?',
   'page.header.register.terms': 'I  agree all statements in terms of service',
   'page.header.register.alreadyRegistered': 'Already registered?',
   ...
   'page.mobile.wallet.withdraw.modal.confirmation.message1':
      "You've requested to withdraw",
