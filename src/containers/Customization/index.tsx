...
class CustomizationContainer extends React.Component<Props, State> {
   ...
   public renderTabs = () => {
      ...
      return [
               ...
               currentTabIndex === 0 ? (
                  <CustomizationThemes
                     ...
                     handleSetCurrentCustomization={
                        this.handleSetCurrentCustomization
                     }
         ...
         },
         {
            content:
               currentTabIndex === 1 ? (
                  <CustomizationFonts translate={this.translate} />
               ) : null,
         ...
         },
         {
            content:
               currentTabIndex === 2 ? (
                  <CustomizationSpacing translate={this.translate} />
               ) : null,
         ...
         },
         {
            content:
               currentTabIndex === 3 ? (
                  <CustomizationImages translate={this.translate} />
               ) : null,
      ...
      return (
         <div className={customizationClassName}>
            <div
               ...
               onClick={e => this.handleToggleIsOpen()}>
               <PaletteIcon />
            </div>
            <TabPanel
   ...
   private handleCheckRoute = () => {
      if (
         ...
         window.location.hash.substring(1) === 'settings'
      ) {
         return true;
      }
   ...
   private handleSetCurrentCustomization = (
      key: string,
      value: string | number
   ) => {
      const { currentCustomization } = this.props;
...
> = dispatch => ({
   ...
   customizationUpdateCurrent: payload =>
      dispatch(customizationUpdateCurrent(payload)),
...
export const Customization = injectIntl(
   withRouter(
      connect(mapStateToProps, mapDispatchProps)(CustomizationContainer) as any
   ) as any
);
