...
class HeaderToolbarContainer extends React.Component<Props> {
   public render() {
      ...
      const isPositive =
         currentMarket &&
         /\+/.test(this.getTickerValue('price_change_percent'));
      ...
      return (
         <div className="pg-header__toolbar">
            ...
            <div className="pg-header__toolbar-item">
               <p
                  className={`pg-header__toolbar-item-value pg-header__toolbar-item-value-${cls}`}>
                  {currentMarket &&
...
const HeaderToolbar = injectIntl(
   withRouter(
      connect(mapStateToProps, {})(HeaderToolbarContainer) as any
   ) as any
);
