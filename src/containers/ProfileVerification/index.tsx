         ...
         case 'submitted':
            return (
               <OverlayTrigger
                  ...
                  overlay={
                     <Tooltip
                        title={`page.body.profile.verification.progress.tooltip.${step}.pending`}
                     />
                  }>
         ...
         case 'rejected':
            return (
               <OverlayTrigger
                  ...
                  overlay={
                     <Tooltip
                        title={`page.body.profile.verification.progress.tooltip.${step}.rejected`}
                     />
                  }>
         ...
         default:
            return (
               <OverlayTrigger
                  ...
                  overlay={
                     <Tooltip
                        title={`page.body.profile.verification.progress.tooltip.${step}.default`}
                     />
                  }>
