...
class AddressComponent extends React.Component<Props, State> {
   ...
   public render() {
      ...
      const addressFocusedClass = cr(
         'pg-confirm__content-address__row__content',
         {
            'pg-confirm__content-address__row__content--focused':
               addressFocused,
            ...
            <div className="pg-confirm__content-address">
                  ...
                  <fieldset className={addressFocusedClass}>
                     <CustomInput
                        ...
                        placeholder={this.translate(
                           'page.body.kyc.address.address.placeholder'
                        )}
               ...
               <div className="pg-confirm__content-address__row input-group">
                  <fieldset className={cityFocusedClass}>
                     <CustomInput
                        ...
                        defaultLabel={''}
                        placeholder={this.translate(
                           'page.body.kyc.address.city.placeholder'
                        )}
                        inputValue={city}
                  ...
                  <fieldset className={postcodeFocusedClass}>
                     <CustomInput
                        ...
                        defaultLabel={''}
                        placeholder={this.translate(
                           'page.body.kyc.address.postcode.placeholder'
                        )}
                        inputValue={postcode}
                        handleChangeInput={e =>
               ...
               <div className="pg-confirm__content-address__row__content">
                  ...
                  <SearchDropdown
                     ...
                     placeholder={this.translate(
                        'page.body.kyc.documents.country.placeholder'
                     )}
                  />
               </div>
               <UploadFile
                  ...
                  title={this.translate(
                     'page.body.kyc.address.uploadFile.title'
                  )}
                  label={this.translate(
                     'page.body.kyc.address.uploadFile.label'
                  )}
                  buttonText={this.translate(
                     'page.body.kyc.address.uploadFile.button'
                  )}
                  sizesText={this.translate(
                     'page.body.kyc.address.uploadFile.sizes'
                  )}
                  formatsText={this.translate(
                     'page.body.kyc.address.uploadFile.formats'
                  )}
                  tipText={this.translate(
                     'page.body.kyc.address.uploadFile.tip'
                  )}
                  handleUploadScan={uploadEvent =>
                     this.handleUploadScan(uploadEvent, 'fileScan')
                  }
