...
class PhoneComponent extends React.Component<Props, PhoneState> {
   ...
   public render() {
      ...
      const phoneNumberFocusedClass = cr(
         'pg-confirm__content-phone-col-content',
         {
            'pg-confirm__content-phone-col-content--focused':
               phoneNumberFocused,
         }
      );

      const confirmationCodeFocusedClass = cr(
         'pg-confirm__content-phone-col-content',
         {
            'pg-confirm__content-phone-col-content--focused':
               confirmationCodeFocused,
            ...
            <div className="pg-confirm__content-phone-col">
               <fieldset className={confirmationCodeFocusedClass}>
                  <CustomInput
                     ...
                     label={
                        confirmationCode
                           ? this.translate('page.body.kyc.phone.code')
                           : ''
                     }
                     defaultLabel={
                        confirmationCode
