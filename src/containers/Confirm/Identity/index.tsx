...
class IdentityComponent extends React.Component<Props, IdentityState> {
   ...
   public componentDidUpdate(prev: Props) {
      ...
      if (
         (!prev.editSuccess && editSuccess) ||
         (!prev.sendSuccess && sendSuccess)
      ) {
   ...
   public render() {
      ...
      const firstNameGroupClass = cr(
         'pg-confirm__content-identity__forms__row__content',
         {
            'pg-confirm__content-identity__forms__row__content--focused':
               firstNameFocused,
      ...
      const dateOfBirthGroupClass = cr(
         'pg-confirm__content-identity__forms__row__content',
         {
            ...
            'pg-confirm__content-identity__forms__row__content--wrong':
               dateOfBirth &&
               !this.handleValidateInput('dateOfBirth', dateOfBirth),
         }
      );
      ...
      const dataCountries = Object.values(countries.getNames(lang)).map(
         item => {
      ...
      return (
         <form
            ...
            <div className="pg-confirm__content-identity__forms">
               <div className="pg-confirm__content-identity__forms__row input-group">
                  <fieldset className={firstNameGroupClass}>
                     <CustomInput
                        ...
                        placeholder={this.translate(
                           'page.body.kyc.identity.firstName'
                        )}
                        handleChangeInput={e =>
                  ...
                  <fieldset className={lastNameGroupClass}>
                     <CustomInput
                        ...
                        placeholder={this.translate(
                           'page.body.kyc.identity.lastName'
                        )}
                        label={this.translate(
                           'page.body.kyc.identity.lastName'
                        )}
                  ...
                  <fieldset className={dateOfBirthGroupClass}>
                     <div className="custom-input">
                        {dateOfBirth ? (
                           <label>
                              {this.translate(
                                 'page.body.kyc.identity.dateOfBirth'
                              )}
                           </label>
                        ) : null}
               ...
               <div className="pg-confirm__content-identity__forms__row">
                  <fieldset className={residentialAddressGroupClass}>
                     <CustomInput
                        ...
                        defaultLabel={''}
                        handleChangeInput={e =>
                           this.handleChange(e, 'residentialAddress')
                        }
               ...
               <div className="pg-confirm__content-identity__forms__row input-group">
                  ...
                  <fieldset className={postcodeGroupClass}>
                     <CustomInput
                        label={this.translate(
                           'page.body.kyc.identity.postcode'
                        )}
                        defaultLabel={this.translate(
                           'page.body.kyc.identity.postcode'
                        )}
                        type="string"
                        name="ship-zip"
            ...
            {sendSuccess && !editSuccess && (
               <p className="pg-confirm__success">
                  {this.translate(sendSuccess)}
               </p>
            )}
            {editSuccess && !sendSuccess && (
               <p className="pg-confirm__success">
                  {this.translate(editSuccess)}
               </p>
            )}
      ...
      return () => {
         switch (field) {
            ...
            case 'residentialAddress':
               this.setState({
                  residentialAddressFocused:
                     !this.state.residentialAddressFocused,
               });
   ...
   private handleConfirmEnterPress = (
   ...
   private handleValidateInput = (field: string, value: string): boolean => {
      switch (field) {
         ...
         case 'residentialAddress':
            const residentialAddressRegex = new RegExp(
               `^[a-zA-Z0-9-,.;~\\/\\s]+$`
            );
   ...
   private handleCheckButtonDisabled = () => {
      ...
      const dateOfBirthValid = this.handleValidateInput(
         'dateOfBirth',
         dateOfBirth
      );
   ...
   private sendData = event => {
      ...
      const lastVerifiedProfile =
         ...
         verifiedProfiles[verifiedProfiles.length - 1];
