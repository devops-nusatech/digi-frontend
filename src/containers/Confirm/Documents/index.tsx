...
class DocumentsComponent extends React.Component<Props, DocumentsState> {
   ...
   public render() {
      ...
      const issuedDateFocusedClass = cr(
         'pg-confirm__content-documents__row__content',
         {
            'pg-confirm__content-documents__row__content--focused':
               issuedDateFocused,
      ...
      const expireDateFocusedClass = cr(
         'pg-confirm__content-documents__row__content',
         {
            'pg-confirm__content-documents__row__content--focused':
               expireDateFocused,
            'pg-confirm__content-documents__row__content--wrong':
               expireDate &&
               !this.handleValidateInput('expireDate', expireDate),
         }
      );
            ...
            <div className="pg-confirm__content-documents">
               <div className="pg-confirm__content-documents__row__content">
                  ...
                  <DropdownComponent
                     ...
                     placeholder={this.translate(
                        'page.body.kyc.documentsType.placeholder'
                     )}
                  />
               </div>
                  ...
                  <fieldset className={idNumberFocusedClass}>
                     <CustomInput
                        ...
                        label={this.translate(
                           'page.body.kyc.documents.idNumber'
                        )}
                        labelVisible={true}
                        defaultLabel={''}
                        placeholder={this.translate(
                           'page.body.kyc.documents.idNumber.placeholder'
                        )}
                        inputValue={idNumber}
               ...
               <div className="pg-confirm__content-documents__row input-group">
                  <fieldset className={issuedDateFocusedClass}>
                     <div className="custom-input">
                        <label>
                           {this.translate(
                              'page.body.kyc.documents.issuedDate'
                           )}
                        </label>
                        <div className="input-group input-group-lg">
                           <MaskInput
                              ...
                              placeholder={this.translate(
                                 'page.body.kyc.documents.issuedDate.placeholder'
                              )}
                           />
                        </div>
                     </div>
                     ...
                     <div className="custom-input">
                        ...
                        <div className="input-group input-group-lg">
                           <MaskInput
                              ...
                              className="group-input"
                              placeholder={this.translate(
                                 'page.body.kyc.documents.expiryDate.placeholder'
                              )}
                           />
                        </div>
                     </div>
               ...
               this.state.documentsType !== 'Passport' ? (
                  <UploadFile
                     ...
                     id="fileBack"
                     title={this.translate(
                        'page.body.kyc.documents.uploadFile.back.title'
                     )}
                     label={this.translate(
                     ...
                     sizesText={this.translate(
                        'page.body.kyc.documents.uploadFile.back.sizes'
                     )}
                     formatsText={this.translate(
               ...
               {this.state.documentsType ? (
                  <UploadFile
                     ...
                     uploadedFile={
                        fileSelfie[0] && (fileSelfie[0] as File).name
                     }
                  />
               ) : null}
   ...
   private sendDocuments = () => {
      ...
      this.props.sendDocuments(
         this.createFormData('front_side', fileFront, identificator)
      );

      if (documentsType !== 'Passport') {
         this.props.sendDocuments(
            this.createFormData('back_side', fileBack, identificator)
         );
      }

      this.props.sendDocuments(
         this.createFormData('selfie', fileSelfie, identificator)
      );
   };
