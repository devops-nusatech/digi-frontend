...
export class OpenOrdersContainer extends React.Component<Props> {
   ...
   public componentWillReceiveProps(next: Props) {
      ...
      const {
         ...
         currentMarket: prevCurrentMarket,
      } = this.props;
      ...
      if (!prevUserLoggedIn && userLoggedIn && currentMarket) {
         ...
         userLoggedIn &&
         currentMarket &&
         prevCurrentMarket !== currentMarket
      ) {
         this.props.userOpenOrdersFetch({ market: currentMarket });
      }
   }
   ...
   private renderHeaders = () => {
      const currentAskUnit = this.props.currentMarket
         ? ` (${this.props.currentMarket.base_unit.toUpperCase()})`
         : '';
