...
class ToggleTwoFactorAuthComponent extends React.Component<Props, State> {
   ...
   private renderToggle2fa = (enable2fa: boolean) => {
      ...
      return (
         <div className="pg-profile-two-factor-auth__form container mt-5 p-0">
            <div className="row pg-profile-two-factor-auth__header m-0">
            ...
            <div className="row pg-profile-two-factor-auth__body m-0">
               <div className="col-12 col-lg-8 col-md-9 pg-profile-two-factor-auth__body--text d-inline-block pr-0 pl-2">
               ...
               <div className="col-12 col-lg-4 col-md-3 pg-profile-two-factor-auth__body--barcode pt-4">
                  {enable2fa && this.renderTwoFactorAuthQR(barcode)}
               </div>
            </div>
            <div className="row pg-profile-two-factor-auth__copyablefield m-0 p-5">
               {enable2fa && secret && this.renderSecret(secret)}
            </div>
            <div className="row pg-profile-two-factor-auth__body m-0">
               <div className="col-12 pg-profile-two-factor-auth__body--text d-inline-block pl-2">
                  <div className="row col-12 pg-profile-two-factor-auth__body--text--group">
