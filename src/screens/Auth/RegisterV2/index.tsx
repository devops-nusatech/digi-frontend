...
import React, { Component, createRef, FC, FunctionComponent, useState } from 'react';
...
import { Button, Captcha, FormRegisterV2, InputGroup, LayoutAuth, Modal } from 'components';
import {
   EMAIL_REGEX,
   ERROR_INVALID_EMAIL,
...
export class RegisterClass extends Component<Props> {
...
export const RegisterV2 = compose(
   injectIntl,
   withRouter,
   connect(mapStateToProps, mapDispatchToProps),
)(RegisterV2FC) as FunctionComponent;
