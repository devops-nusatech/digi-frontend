         ...
         <>
            ...
            <div className="space-y-12">
               ...
               <div className="space-y-8">
                  ...
                  <label className="group relative inline-block cursor-pointer select-none">
                     <input
                        type="checkbox"
                        checked
                     ...
                     <span className="flex space-x-3">
                        ...
                        <span className="font-medium leading-custom">
                           Save Card
                        </span>
                     </span>
                  </label>
         ...
         <>
            ...
            <div className="space-y-12">
               <div className="flex justify-between rounded-2xl bg-neutral7 py-6 px-9 dark:bg-neutral2">
                  ...
                  <div className="flex space-x-2.5">
                     <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-secondary1">
                        <svg className="h-5 w-5 fill-neutral8">
                           <use xlinkHref="#icon-wallet"></use>
                        </svg>
                     </div>
