...
export const customizationUpdate = (
   payload: CustomizationUpdate['payload']
): CustomizationUpdate => ({
   type: CUSTOMIZATION_UPDATE,
   payload,
});

export const customizationUpdateData = (
   payload: CustomizationUpdateData['payload']
): CustomizationUpdateData => ({
   type: CUSTOMIZATION_UPDATE_DATA,
   payload,
});

export const customizationUpdateError = (
   error: CommonError
): CustomizationUpdateError => ({
