...
export const PROFILE_GENERATE_2FA_QRCODE_FETCH =
   'profile/GENERATE_2FA_QRCODE_FETCH';
export const PROFILE_GENERATE_2FA_QRCODE_DATA =
   'profile/GENERATE_2FA_QRCODE_DATA';
export const PROFILE_GENERATE_2FA_QRCODE_ERROR =
   'profile/GENERATE_2FA_QRCODE_ERROR';
...
export const PROFILE_TIER_FETCH = 'profile/TIER_FETCH';
export const PROFILE_TIER_DATA = 'profile/TIER_DATA';
export const PROFILE_TIER_ERROR = 'profile/TIER_ERROR';
