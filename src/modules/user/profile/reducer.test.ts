...
describe('Profile reducer', () => {
   ...
   it('should handle GET_USER_FETCH', () => {
      ...
      expect(profileReducer(initialStateProfile, actions.userFetch())).toEqual(
         expectedState
      );
   });
   ...
   it('should handle GET_USER_DATA', () => {
      ...
      expect(profileReducer(actualState, actions.userData(userData))).toEqual(
         expectedState
      );
   });
   ...
   it('should handle GET_USER_ERROR', () => {
      ...
      expect(profileReducer(actualState, actions.userError(error))).toEqual(
         expectedState
      );
   });
   ...
   it('should handle RESET_USER', () => {
      ...
      expect(profileReducer(actualState, actions.userReset())).toEqual(
         expectedState
      );
   });
   ...
   it('should handle CHANGE_USER_LEVEL', () => {
      ...
      expect(
         profileReducer(actualState, actions.changeUserLevel({ level: 2 }))
   ...
   it('should handle CHANGE_PASSWORD_FETCH', () => {
      ...
      expect(
         profileReducer(
            initialStateProfile,
            actions.changePasswordFetch(payload)
         )
      ).toEqual(expectedState);
   });
   ...
   it('should handle CHANGE_PASSWORD_DATA', () => {
      ...
      expect(profileReducer(actualState, actions.changePasswordData())).toEqual(
         expectedState
      );
   });
   ...
   it('should handle CHANGE_PASSWORD_ERROR', () => {
      ...
      expect(
         profileReducer(actualState, actions.changePasswordError(error))
      ).toEqual(expectedState);
   });
   ...
   it('should handle GENERATE_2FA_QRCODE_FETCH', () => {
      ...
      expect(
         profileReducer(initialStateProfile, actions.generate2faQRFetch())
      ).toEqual(expectedState);
   });
   ...
   it('should handle GENERATE_2FA_QRCODE_DATA', () => {
      ...
      const expectedState = {
         ...initialStateProfile,
         twoFactorAuth: {
            ...actualState.twoFactorAuth,
            error: undefined,
            ...payload,
         },
      };
      expect(
         profileReducer(actualState, actions.generate2faQRData(payload))
      ).toEqual(expectedState);
   });
   ...
   it('should handle GENERATE_2FA_QRCODE_ERROR', () => {
      ...
      expect(
         profileReducer(actualState, actions.generate2faQRError(error))
      ).toEqual(expectedState);
   });
   ...
   it('should handle TOGGLE_2FA_FETCH', () => {
      ...
      expect(
         profileReducer(initialStateProfile, actions.toggle2faFetch(payload))
      ).toEqual(expectedState);
   });
   ...
   it('should handle TOGGLE_2FA_DATA', () => {
      ...
      expect(profileReducer(actualState, actions.toggle2faData())).toEqual(
         expectedState
      );
   });
   ...
   it('should handle TOGGLE_2FA_ERROR', () => {
      ...
      expect(
         profileReducer(actualState, actions.toggle2faError(error))
      ).toEqual(expectedState);
   });
   ...
   it('should handle CHANGE_USER_FETCH', () => {
      ...
      expect(
         profileReducer(
            actualState,
            actions.changeUserDataFetch({ user: userData.user })
         )
      ).toEqual(expectedState);
   });
   ...
   it('should handle CHANGE_USER_DATA', () => {
      ...
      expect(
         profileReducer(
            actualState,
            actions.changeUserData({ user: userData.user })
         )
      ).toEqual(expectedState);
   });
});
