...
import { Wallet, WalletAddress, WalletTransfer, WalletWithdrawCCY } from './types';
...
export interface WalletsTransferFetch {
    type: typeof WALLETS_TRANSFER_FETCH;
    payload: WalletTransfer;
}

export interface WalletsTransferData {
    type: typeof WALLETS_TRANSFER_DATA;
}

export interface WalletsTransferError {
    type: typeof WALLETS_TRANSFER_ERROR;
    error: CommonError;
}
export interface WalletsTransferSuccess {
    type: typeof WALLETS_TRANSFER_SUCCESS;
}
...
export type WalletsAction = WalletsFetch
    ...
    | WalletsTransferData
    | WalletsTransferError
    | WalletsTransferSuccess
    | WalletsReset
    | SetMobileWalletUi;
...
export const walletsTransferFetch = (payload: WalletsTransferFetch['payload']): WalletsTransferFetch => ({
    type: WALLETS_TRANSFER_FETCH,
    payload,
});

export const walletsTransferData = (): WalletsTransferData => ({
    type: WALLETS_TRANSFER_DATA,
});

export const walletsTransferError = (error: CommonError): WalletsTransferError => ({
    type: WALLETS_TRANSFER_ERROR,
    error,
});
export const walletsTransferSuccess = (): WalletsTransferSuccess => ({
    type: WALLETS_TRANSFER_SUCCESS,
});
