...
export const WALLETS_TRANSFER_FETCH = 'wallets/TRANSFER_FETCH';
export const WALLETS_TRANSFER_DATA = 'wallets/TRANSFER_DATA';
export const WALLETS_TRANSFER_ERROR = 'wallets/TRANSFER_ERROR';
export const WALLETS_TRANSFER_SUCCESS = 'wallets/TRANSFER_SUCCESS';
