         ...
         if (payload.currencies.includes(wallet.currency)) {
            ...
            const walletDepositAddressExist =
               wallet.deposit_addresses?.findIndex(
                  item => item.blockchain_key === payload.blockchain_key
               ) !== -1;
            ...
            if (payload.blockchain_key && !walletDepositAddressExist) {
               ...
               depositAddresses = [
                  ...(wallet.deposit_addresses !== undefined
               ...
               wallet.deposit_addresses &&
               wallet.deposit_addresses.length &&
               walletDepositAddressExist
            ) {
      ...
      if (payloadCurrencies.length) {
         payloadCurrencies.some(value => {
            ...
            if (
               ...
               updatedWallet = {
                  ...updatedWallet,
                  balance: targetWallet[0]
                     ? targetWallet[0]
                     : updatedWallet.balance,
                  locked: targetWallet[1]
                     ? targetWallet[1]
