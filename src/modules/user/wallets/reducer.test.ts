...
describe('walletsList reducer', () => {
   ...
   it('should handle WALLETS_FETCH', () => {
      ...
      expect(
         walletsReducer(initialWalletsState, actions.walletsFetch())
   ...
   it('should handle WALLETS_DATA', () => {
      ...
      expect(
         walletsReducer(initialWalletsState, actions.walletsData(wallets))
      ).toEqual(expectedState);
   });
   ...
   it('should handle WALLETS_ERROR', () => {
      ...
      expect(
         walletsReducer(initialWalletsState, actions.walletsError(error))
      ).toEqual(expectedState);
   });
   ...
   it('should handle WALLETS_ADDRESS_FETCH', () => {
      ...
      expect(
         walletsReducer(
            initialWalletsState,
            actions.walletsAddressFetch(addressFetchPayload)
         )
      ).toEqual(expectedState);
   });
   ...
   it('should handle WALLETS_ADDRESS_DATA', () => {
      ...
      expect(
         walletsReducer(
            initialState,
            actions.walletsAddressData(addressDataPayload)
         )
      ).toEqual(expectedState);
   });
   ...
   it('should handle WALLETS_ADDRESS_ERROR', () => {
      ...
      expect(
         walletsReducer(initialWalletsState, actions.walletsAddressError(error))
      ).toEqual(expectedState);
   });
   ...
   it('should handle WALLETS_WITHDRAW_CCY_DATA', () => {
      ...
      expect(
         walletsReducer(initialWalletsState, actions.walletsWithdrawCcyData())
      ).toEqual(expectedState);
   });
   ...
   it('should handle WALLETS_WITHDRAW_CCY_ERROR', () => {
      ...
      expect(
         walletsReducer(
            initialWalletsState,
            actions.walletsWithdrawCcyError(error)
         )
      ).toEqual(expectedState);
   });
});
