import { GeetestCaptchaResponse, GeetestCaptchaV4Response } from '../..';
...
export interface GeetestCaptchaSuccess {
   ...
   payload: {
      captcha_response?: GeetestCaptchaResponse | GeetestCaptchaV4Response;
   };
}
...
export const geetestCaptchaData = (
   keys: GeetestCaptchaKeys
): GeetestCaptchaData => ({
...
export const geetestCaptchaError = (
   error: CommonError
): GeetestCaptchaError => ({
...
export const setRecaptchaSuccess = (
   payload: RecaptchaSuccess['payload']
): RecaptchaSuccess => ({
