import { GeetestCaptchaResponse, GeetestCaptchaV4Response, RootState } from '../..';
...
export const selectCaptchaResponse = (state: RootState): string | GeetestCaptchaResponse | GeetestCaptchaV4Response | undefined =>
