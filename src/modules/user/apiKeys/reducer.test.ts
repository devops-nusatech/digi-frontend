...
describe('Api Keys reducers', () => {
   it('should handle API_KEYS_DATA', () => {
      ...
      expect(
         apiKeysReducer(initialApiKeysState, actions.apiKeysData(payload))
   ...
   it('should handle API_KEY_CREATE', () => {
      ...
      expect(
         apiKeysReducer(initialApiKeysState, actions.apiKeyCreate(payload))
            .apiKeys
               ...
               apiKeys: [
                  {
                     kid: '1',
                     state: 'disabled',
                     updated_at: '28-05-2019 13:52:10',
                  },
               ] as actions.ApiKeyDataInterface[],
            },
