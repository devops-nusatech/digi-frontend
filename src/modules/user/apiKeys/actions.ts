...
export const apiKeysFetch = (
   payload: ApiKeysFetch['payload']
): ApiKeysFetch => ({
   type: API_KEYS_FETCH,
   payload,
});
...
export const apiKeyCreateFetch = (
   payload: ApiKeyCreateFetch['payload']
): ApiKeyCreateFetch => ({
...
export const apiKeyCreate = (
   payload: ApiKeyCreateData['payload']
): ApiKeyCreateData => ({
   type: API_KEY_CREATE,
   payload,
});

export const apiKeyUpdateFetch = (
   payload: ApiKeyUpdateFetch['payload']
): ApiKeyUpdateFetch => ({
...
export const apiKeyUpdate = (
   payload: ApiKeyUpdate['payload']
): ApiKeyUpdate => ({
   type: API_KEY_UPDATE,
   payload,
});

export const apiKeyDeleteFetch = (
   payload: ApiKeyDeleteFetch['payload']
): ApiKeyDeleteFetch => ({
...
export const apiKeyDelete = (
   payload: ApiKeyDelete['payload']
): ApiKeyDelete => ({
   type: API_KEY_DELETE,
   payload,
});

export const apiKeys2FAModal = (
   payload: ApiKeys2FAModal['payload']
): ApiKeys2FAModal => ({
