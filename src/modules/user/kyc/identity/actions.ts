...
export const sendIdentity = (
   payload: SendIdentityFetch['payload']
): SendIdentityFetch => ({
   type: SEND_IDENTITY_FETCH,
   payload,
});

export const sendIdentityData = (
   payload: SendIdentityData['payload']
): SendIdentityData => ({
...
export const editIdentity = (
   payload: EditIdentityFetch['payload']
): EditIdentityFetch => ({
   type: EDIT_IDENTITY_FETCH,
   payload,
});

export const editIdentityData = (
   payload: EditIdentityData['payload']
): EditIdentityData => ({
