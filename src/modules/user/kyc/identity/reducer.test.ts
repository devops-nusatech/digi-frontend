...
describe('Identity reducer', () => {
   ...
   it('should handle SEND_IDENTITY_FETCH', () => {
      ...
      expect(
         identityReducer(
            initialIdentityState,
            actions.sendIdentity(confirmIdentityPayload)
         )
   ...
   it('should handle SEND_IDENTITY_DATA', () => {
      ...
      expect(
         identityReducer(
            initialIdentityState,
            actions.sendIdentityData(confirmIdentityResponse)
         )
      ).toEqual(expectedState);
   });
   ...
   it('should handle SEND_IDENTITY_ERROR', () => {
      ...
      expect(
         identityReducer(initialIdentityState, actions.sendIdentityError(error))
      ).toEqual(expectedState);
   });
   ...
   it('should handle EDIT_IDENTITY_FETCH', () => {
      ...
      expect(
         identityReducer(
            initialIdentityState,
            actions.editIdentity(confirmIdentityPayload)
         )
      ).toEqual(expectedState);
   });
   ...
   it('should handle EDIT_IDENTITY_DATA', () => {
      ...
      expect(
         identityReducer(
            initialIdentityState,
            actions.editIdentityData(confirmIdentityResponse)
         )
      ).toEqual(expectedState);
   });
   ...
   it('should handle EDIT_IDENTITY_ERROR', () => {
      ...
      expect(
         identityReducer(initialIdentityState, actions.editIdentityError(error))
      ).toEqual(expectedState);
   });
});
