...
describe('Label reducer', () => {
   ...
   it('should handle GET_LABEL_FETCH', () => {
      ...
      expect(labelReducer(initialLabelState, actions.labelFetch())).toEqual(
         expectedState
      );
   });
   ...
   it('should handle GET_LABEL_DATA', () => {
      ...
      expect(
         labelReducer(initialLabelState, actions.labelData(labelData))
   ...
   it('should handle GET_LABEL_ERROR', () => {
      ...
      expect(
         labelReducer(initialLabelState, actions.labelError(error))
      ).toEqual(expectedState);
   });
});
