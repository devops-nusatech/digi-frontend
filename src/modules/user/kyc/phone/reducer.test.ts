...
describe('Phone reducer', () => {
   ...
   it('should handle SEND_CODE_FETCH', () => {
      ...
      expect(
         phoneReducer(initialPhoneState, actions.sendCode(sendPhonePayload))
   ...
   it('should handle SEND_CODE_DATA', () => {
      ...
      expect(phoneReducer(initialPhoneState, actions.sendCodeData())).toEqual(
         expectedState
      );
   });
   ...
   it('should handle SEND_CODE_ERROR', () => {
      ...
      expect(
         phoneReducer(initialPhoneState, actions.sendCodeError(error))
      ).toEqual(expectedState);
   });
   ...
   it('should handle RESEND_CODE_FETCH', () => {
      ...
      expect(
         phoneReducer(initialPhoneState, actions.resendCode(sendPhonePayload))
      ).toEqual(expectedState);
   });
   ...
   it('should handle RESEND_CODE_DATA', () => {
      ...
      expect(phoneReducer(initialPhoneState, actions.resendCodeData())).toEqual(
         expectedState
      );
   });
   ...
   it('should handle RESEND_CODE_ERROR', () => {
      ...
      expect(
         phoneReducer(initialPhoneState, actions.resendCodeError(error))
      ).toEqual(expectedState);
   });
   ...
   it('should handle VERIFY_PHONE_FETCH', () => {
      ...
      expect(
         phoneReducer(
            initialPhoneState,
            actions.verifyPhone(verifyCodeFetchPayload)
         )
      ).toEqual(expectedState);
   });
   ...
   it('should handle VERIFY_PHONE_DATA', () => {
      ...
      expect(
         phoneReducer(
            initialPhoneState,
            actions.verifyPhoneData(verifyCodeDataPayload)
         )
      ).toEqual(expectedState);
   });
   ...
   it('should handle VERIFY_PHONE_ERROR', () => {
      ...
      expect(
         phoneReducer(initialPhoneState, actions.verifyPhoneError(error))
      ).toEqual(expectedState);
   });
});
