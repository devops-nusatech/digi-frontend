...
describe('Beneficiaries reducer', () => {
   ...
   it('should handle beneficiariesData', () => {
      ...
      expect(
         beneficiariesReducer(
            initialBeneficiariesState,
            actions.beneficiariesData(fakeBeneficiaries)
         )
      ).toEqual(expectedState);
   });
   ...
   it('should handle beneficiariesDataUpdate', () => {
      ...
      expect(
         beneficiariesReducer(
            initialState,
            actions.beneficiariesDataUpdate(fakeBeneficiary)
         )
      ).toEqual(expectedState);
   });
   ...
   it('should handle beneficiariesError', () => {
      ...
      expect(
         beneficiariesReducer(
            initialBeneficiariesState,
            actions.beneficiariesError(error)
         )
      ).toEqual(expectedState);
   });
   ...
   it('should handle beneficiariesActivate', () => {
      ...
      expect(
         beneficiariesReducer(
            initialBeneficiariesState,
            actions.beneficiariesActivate(fakePayload)
         )
      ).toEqual(expectedState);
   });
   ...
   it('should handle beneficiariesActivateError', () => {
      ...
      expect(
         beneficiariesReducer(
            initialBeneficiariesState,
            actions.beneficiariesActivateError(error)
         )
      ).toEqual(expectedState);
   });
   ...
   it('should handle beneficiariesCreate', () => {
      ...
      expect(
         beneficiariesReducer(
            initialBeneficiariesState,
            actions.beneficiariesCreate(fakePayload)
         )
      ).toEqual(expectedState);
   });
   ...
   it('should handle beneficiariesCreateError', () => {
      ...
      expect(
         beneficiariesReducer(
            initialBeneficiariesState,
            actions.beneficiariesCreateError(error)
         )
      ).toEqual(expectedState);
   });
   ...
   it('should handle beneficiariesDelete', () => {
      ...
      expect(
         beneficiariesReducer(
            initialBeneficiariesState,
            actions.beneficiariesDelete(fakePayload)
         )
      ).toEqual(expectedState);
   });
   ...
   it('should handle beneficiariesDeleteError', () => {
      ...
      expect(
         beneficiariesReducer(
            initialBeneficiariesState,
            actions.beneficiariesDeleteError(error)
         )
      ).toEqual(expectedState);
   });
   ...
   it('should handle beneficiariesResendPin', () => {
      ...
      expect(
         beneficiariesReducer(
            initialBeneficiariesState,
            actions.beneficiariesResendPin(fakePayload)
         )
      ).toEqual(expectedState);
   });
   ...
   it('should handle beneficiariesResendPinError', () => {
      ...
      expect(
         beneficiariesReducer(
            initialBeneficiariesState,
            actions.beneficiariesResendPinError(error)
         )
      ).toEqual(expectedState);
   });
});
