...
describe('Beneficiaries actions', () => {
   const fakeBeneficiariesArray: Beneficiary[] = [
      {
         ...
         data: {
            address:
               '0xa96bbd0de64ef10659ae49d5ca4bb8109169007eb90d53aa3f87b6dc65530d8a',
         },
      },
      {
         id: 2,
   ...
   it('should check beneficiariesActivateData action creator', () => {
      ...
      expect(actions.beneficiariesActivateData(fakeActiveBeneficiary)).toEqual(
         expectedAction
      );
   });
   ...
   it('should check beneficiariesActivateError action creator', () => {
      ...
      expect(actions.beneficiariesActivateError(fakeError)).toEqual(
         expectedAction
      );
   });
   ...
   it('should check beneficiariesCreate action creator', () => {
      ...
      const expectedAction = {
         ...
         payload: fakeCreatePayload,
      };
      expect(actions.beneficiariesCreate(fakeCreatePayload)).toEqual(
         expectedAction
      );
   });
   ...
   it('should check beneficiariesCreateData action creator', () => {
      ...
      const expectedAction = {
         ...
         payload: fakeCreateBeneficiary,
      };
      expect(actions.beneficiariesCreateData(fakeCreateBeneficiary)).toEqual(
         expectedAction
      );
   });
   ...
   it('should check beneficiariesCreateError action creator', () => {
      ...
      expect(actions.beneficiariesCreateError(fakeError)).toEqual(
         expectedAction
      );
   });
   ...
   it('should check beneficiariesDeleteError action creator', () => {
      ...
      expect(actions.beneficiariesDeleteError(fakeError)).toEqual(
         expectedAction
      );
   });
   ...
   it('should check beneficiariesFetch action creator', () => {
      const expectedAction = {
         ...
         payload: { currency_id: 'btc' },
      };
      expect(actions.beneficiariesFetch({ currency_id: 'btc' })).toEqual(
         expectedAction
      );
   });
   ...
   it('should check beneficiariesData action creator', () => {
      const expectedAction = {
         ...
         payload: fakeBeneficiariesArray,
      };
      expect(actions.beneficiariesData(fakeBeneficiariesArray)).toEqual(
         expectedAction
      );
   });
   ...
   it('should check beneficiariesDataUpdate action creator', () => {
      ...
      expect(actions.beneficiariesDataUpdate(fakeCreateBeneficiary)).toEqual(
         expectedAction
      );
   });
   ...
   it('should check beneficiariesResendPinData action creator', () => {
      ...
      expect(actions.beneficiariesResendPinData(payload)).toEqual(
         expectedAction
      );
   });
   ...
   it('should check beneficiariesResendPinError action creator', () => {
      ...
      expect(actions.beneficiariesResendPinError(fakeError)).toEqual(
         expectedAction
      );
   });
});
