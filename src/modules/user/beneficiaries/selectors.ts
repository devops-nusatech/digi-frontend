...
export const selectBeneficiariesFetchError = (
   state: RootState
): CommonError | undefined => state.user.beneficiaries.fetch.error;

/* Beneficiaries activate */
export const selectBeneficiariesActivateData = (
   state: RootState
): Beneficiary => state.user.beneficiaries.activate.data;
...
export const selectBeneficiariesActivateError = (
   state: RootState
): CommonError | undefined => state.user.beneficiaries.activate.error;
...
export const selectBeneficiariesCreateError = (
   state: RootState
): CommonError | undefined => state.user.beneficiaries.create.error;
...
export const selectBeneficiariesDeleteError = (
   state: RootState
): CommonError | undefined => state.user.beneficiaries.delete.error;

/* Beneficiaries resend pin */
export const selectBeneficiariesResendPinLoading = (
   state: RootState
): boolean => state.user.beneficiaries.resendPin.fetching;

export const selectBeneficiariesResendPinSuccess = (
   state: RootState
): boolean => state.user.beneficiaries.resendPin.success;

export const selectBeneficiariesResendPinError = (
   state: RootState
): CommonError | undefined => state.user.beneficiaries.resendPin.error;
