...
export const selectAvailableQuote = (state: RootState): number => selectOrdersState(state).availableQuote;
export const selectAvailableBase = (state: RootState): number => selectOrdersState(state).availableBase;
