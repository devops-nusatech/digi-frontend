...
describe('Forgot password reducer', () => {
   const request = { email: 'admin@digiassetindo.com' };
   ...
   it('should handle forgot password fetch', () => {
      ...
      expect(
         passwordReducer(initialState, actions.forgotPassword(request))
   ...
   it('should handle forgot password success', () => {
      ...
      expect(
         passwordReducer(actualState, actions.forgotPasswordSuccess())
      ).toEqual(expectedState);
   });
   ...
   it('should handle forgot password error', () => {
      ...
      expect(
         passwordReducer(actualState, actions.forgotPasswordError(error))
      ).toEqual(expectedState);
   });
});
