...
export const selectMarketTickersLoading = (state: RootState): boolean =>
    selectMarketsState(state).tickerLoading;
...
export const selectMarketChartLoading = (state: RootState): boolean => selectMarketsState(state).chartLoading;
