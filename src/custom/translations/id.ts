...
export const id: LangType = {
   ...
   'page.body.trade.header.markets': 'Pasar',
   'page.body.trade.header.discover': 'Temukan',
   'page.body.trade.header.buy_crypto': 'Beli Crypto',
   'page.body.trade.header.events': 'Events',
   'page.body.trade.header.credit_card': 'Kartu kredit',
   'page.body.trade.header.deposit_bank': 'Kartu Debit',
   'page.body.trade.header.airdrop': 'Airdrop',
   'page.body.trade.header.membership': 'Membership',
   'page.body.trade.header.launchpad': 'Launchpad',
 ...
 If you forget you Secret Key, please delete it and apply for a new Secret Key pair.`,
   ...
   'page.header.login': 'Masuk',
   'page.header.login.email': 'Alamat Email',
   ...
   'identity.session.rack_attack_limit': 'Kode pin salah',
   ...
   'market.trade.invalid_type': 'Type salah',
