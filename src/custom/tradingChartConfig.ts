...
export const customWidgetOptions = (colorTheme?: string) => {
   ...
   const primaryColor = convertRgbToHex(
      getStylesValueByKey(colors.dark.chart.primary)
   );
   const upColor = convertRgbToHex(getStylesValueByKey(colors.dark.chart.up));
   const downColor = convertRgbToHex(
      getStylesValueByKey(colors.dark.chart.down)
   );
